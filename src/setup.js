...
async function createInputFiles() {
  ...
  createFileWithContentIfItDoesNotExist(
    ...
    `{visit https://adventofcode.com/2024/day/${day} and paste the part 1 input here}`,
  );

  createFileWithContentIfItDoesNotExist(
    path.join(inputDayPath, 'part2.txt'),
    `{After completing day 1, visit https://adventofcode.com/2024/day/${day} and paste the part 2 input here, or delete this file to re-use the part 1 input}`,
  );
}
